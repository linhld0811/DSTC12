...
```
huggingface-cli download meta-llama/Llama-Guard-3-1B --local-dir Llama-Guard-3-1B --exclude="*original*" --token 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
huggingface-cli download meta-llama/Llama-Guard-3-8B --local-dir Llama-Guard-3-8B --exclude="*original*" --token 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
```
# Download dataset
```
